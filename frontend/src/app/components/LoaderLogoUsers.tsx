...
export default function LoaderLogo({ onFinish }: Props) {
  ...
  const logoFadeControls = useAnimation();
  ...
  }, [pulseControls, fadeControls, bgFadeControls, logoFadeControls, onFinish]);
    ...
    <>
      ...
      {showLogo && (
        <motion.img
          ...
          animate={isPulsing ? pulseControls : logoFadeControls}
          style={{
            position: "fixed",
            zIndex: 9999,
