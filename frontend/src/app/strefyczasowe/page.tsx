...
export default function LoadingPage() {
  ...
  return (
    ...
    >
      ...
      <img
        src="/strefy.svg"
        alt="Mask"
        className="fixed inset-0 z-10 w-full h-full object-cover object-center pointer-events-none"
      />
      <img
        src="/logo_strefy.svg"
        alt="Logo"
      ...
      <div
        className={`
    fixed left-1/2 z-30 text-[15rem] leading-[0.9] text-[#FF4F23]
  ...
  `}
      ...
      text-[#C3D0E1] text-[3rem] leading-[1.2]
